...
public class OptionalExample {
    ...
    private static void withFilter() {
        ...
        System.out.println(priceIsInRange(new com.ds2.java.optional.Modem(10.5)));
    }

    private static boolean priceIsInRange(com.ds2.java.optional.Modem modem2) {
        return Optional.ofNullable(modem2)
                .map(com.ds2.java.optional.Modem::getPrice)
                .filter(p -> p >= 10)
                .filter(p -> p <= 15)
                .isPresent();
    }
